...
// ==========================================
// CONTROLE DE ENTRADA E ÁUDIO DO SITE (LOCALSTORAGE)
// ==========================================
...
document.addEventListener("DOMContentLoaded", () => {
    // Verifica se já existe o carimbo que o usuário clicou antes
    const jaEntrou = localStorage.getItem("gustavoPlacares_entrou");

    if (jaEntrou === "true") {
        // Se já entrou antes, esconde a tela de entrada imediatamente
        if (telaEntrada) {
...
// Configura o clique do botão ENTRAR (só aparece na primeira visita)
if (btnEntrar) {
    btnEntrar.addEventListener("click", () => {
        // Salva no navegador o carimbo de acesso permanente
        localStorage.setItem("gustavoPlacares_entrou", "true");
        ...
        // Some com a tela de entrada para mostrar os jogos
        if (telaEntrada) {
            telaEntrada.style.display = "none";
        }
    });
