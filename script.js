...
async function carregarJogos() {
    ...
    if(containerJogos) containerJogos.innerHTML = `<h3 style="text-align:center;color:#fff;margin-top:40px;font-family:sans-serif;">Entrando em campo 🏟️ Aguarde...</h3>`;
...
function mostrarJogos() {
    ...
    jogosFiltrados.forEach(jogo => {
        ...
        // Aqui voltamos para mostrar 0 - 0 mesmo antes do jogo começar:
        ...
        <div class="card" style="background:#1e1e1e;padding:15px;margin:10px;border-radius:8px;font-family:sans-serif;color:white;box-shadow: 0 4px 6px rgba(0,0,0,0.3);">
            ...
            <div style="display:flex;justify-content:space-between;align-items:center;">
                <div style="width:35%;text-align:center;">
                    ...
                    <div style="font-size:14px;font-weight:bold;">${jogo.homeTeam?.shortName || jogo.homeTeam?.name || "Casa"}</div>
                </div>
                <div style="width:30%;text-align:center;">
                    <div style="font-size:20px;font-weight:bold;background:#2d2d2d;padding:5px 10px;border-radius:5px;">${golsHome} - ${golsAway}</div>
                ...
                <div style="width:35%;text-align:center;">
                    ...
                    <div style="font-size:14px;font-weight:bold;">${jogo.awayTeam?.shortName || jogo.awayTeam?.name || "Fora"}</div>
                </div>
            </div>
        </div>`;
    });
