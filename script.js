// ==========================================
// CONTROLE DE ENTRADA E ÁUDIO (CORRIGIDO)
// ==========================================
...
// Detecta de forma moderna se a página foi ATUALIZADA (F5)
const navegacao = performance.getEntriesByType("navigation")[0];
const foiAtualizado = navegacao && navegacao.type === "reload";

// Pega o histórico da sessão atual
const jaEntrouNestaSessao = sessionStorage.getItem("gustavoPlacares_entrou_sessao");

// Se ele já entrou E a página foi apenas atualizada, esconde a tela de entrada direto
...
if (btnEntrar) {
    btnEntrar.onclick = function() {
        // Grava na sessão que o usuário clicou para entrar
...
t campoPesquisa = document.getElementById("pesquisa");
if (campoPesquisa) {
    campoPesquisa.addEventListener("input", mostrarJogos);
}
